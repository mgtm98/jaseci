...
class TestElasticsearchLogging:
    ...
    def setup_class(cls) -> None:
        ...
        cls.logger_jac_file = cls.fixtures_dir / "elastic_search" / "logger_test_app.jac"
        ...
        cls.es_container = ElasticSearchContainer(
            "docker.elastic.co/elasticsearch/elasticsearch:7.17.10"
        ).with_env("discovery.type", "single-node").with_env(
...
"""
    ...
    def test_jac_logger_to_elasticsearch(self) -> None:
        ...
        print(f"✅ Test passed! Successfully verified {len(test_logs)} logs in Elasticsearch")
